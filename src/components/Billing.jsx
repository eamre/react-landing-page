...
const Billing = () => (
  <section id='product' className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      -left-1/2 top-0 w-[50%] h-[50%] rounded-full white__gradient'/>
      <div className="absolute z-[0] 
      w-[50%] h-[50%] -left-1/2 bottom-0 rounded-full pink__gradient"/>
    </div>
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className='flex flex-row sm:mt-10 mt-6 mx-10' >
